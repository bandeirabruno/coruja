...
<div id="minhasTurmas">
    <fieldset>
        ...
        if( count($turmas) == 0 ) {
        ?>
        <span>Nenhuma turma dispon&iacute;vel.</span><img src="/coruja/imagens/comment_icon.png" title="Somente turmas confirmadas s�o exibidas nessa lista."/>
        <?php 
        } else {
        ...
        <ul>
            <li>
                ...
                <?php } ?>
                <input id="gerarPauta" type="button" value="Gerar Pauta" title="Gerar em PDF a pauta j� liberada" onclick="gerarPauta(<?php echo $turma->getIdTurma(); ?>);" />
        </ul>
