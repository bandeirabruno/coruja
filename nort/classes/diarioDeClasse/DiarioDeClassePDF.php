    ...
    public function gerarFolhaNotas( Turma $turma ) {
        ...
        foreach($inscricoes as $inscricao) {
            ...
            foreach($itensCriterioAvaliacaoInscricaoNota as $itemCriterioAvaliacaoInscricaoNota) {
                ...
                if($siglaPeriodoLetivo == "2020.1" && $itemCriterioAvaliacao->exibir($inscricao) == "RF" ){
                    $this->Cell(23,$espacamento, 'IN' ,1,0,'',1);
                }
                else{
                    $this->Cell(23,$espacamento, $itemCriterioAvaliacao->exibir($inscricao) ,1,0,'',1); //Somente essa linha é original
                }
                //Fim gambiarra
            }
            $this->Ln();
