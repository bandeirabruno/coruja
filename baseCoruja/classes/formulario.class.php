...
class formulario{
    ...
    function inputSelectEnum($nome,$tabela,$coluna,$selecionado) {
        ...
        $result=BD::mysqli_query("SHOW COLUMNS FROM $tabela WHERE field='$coluna'");
    ...
    function inputSelectDinamico($nome,$tabela,$coluna1,$coluna2) {
            ...
            $result = BD::mysqli_query("SELECT DISTINCT $coluna1,$coluna2 FROM $tabela");               
    ...
    function inputValorId($nome,$tabela,$idRef,$descricao) {
        ...
        $result = BD::mysqli_query("SELECT $nome,$descricao FROM $tabela WHERE $nome='$idRef'");               
                ...
                // descobrir o tipo de campo  
                    ...
                    $tipocampo = mysqli_fetch_field_direct($result, 1);
                    //$tipocampo = mysqli_fetch_field($result,"1"); $tipocampo->type 
                    
                if($tipocampo->type == 'date'){ 
    ...
    function inputSelectDinamicoProf($nome, $selecionado) {
        ...
        $resultProf = BD::mysqli_query("SELECT matriculaprofessor.matriculaProfessor,matriculaprofessor.idPessoa,Pessoa.idPessoa,Pessoa.nome ".
        ...
        $selectDinamicoProf .= "<option value='' selected='selected'>SELECIONE</option>";    
                ...
                while ($rowProf=mysqli_fetch_array($resultProf))
                {   
