...
*/
    ...
    $this->opcao = $opcao;
        ...
        $resMat = BD::mysqli_query($sqlMat,$con);
        ...
        while($rowMat = mysqli_fetch_array($resMat))
        {
            ...
            $resTipoDocs = BD::mysqli_query($sqlTipoDocs,$con);
            ...
            while($rowTipoDocs = mysqli_fetch_array($resTipoDocs))
            {
                ...
                $resDocs = BD::mysqli_query($sqlDocs,$con);    
                
                // ESTA LINHA É PARA O CASO DE UM DOCUMENTO CADASTRADO POSTERIORMENTE
                $existe = mysqli_num_rows($resDocs);
                
                $rowDocs = mysqli_fetch_array($resDocs);
