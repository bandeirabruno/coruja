...
class Log 
{
    ...
    public static function obterInformacoesPaginacao($whereConditions, $whereValues, $paginaAtual, $totalRegistrosPorPargina = 50) { 
        ...
        $infosPaginacao['totalRegistros'] = mysqli_num_rows($result);
    ...
    public static function select($whereConditions, $whereValues, $offSet = 0, $limit = 50) {
        ...
        $arrLogs = array();
        $result = BD::mysqli_query($queryFinal, $con);
    ...
    */
    ...
    public static function incluirLog( $idPessoa,$idCasoUso,$descricao,$con = NULL)
    {
    ...
    public static function incluirLogVali( $idPessoa,$idCasoUso,$descricao,$con = NULL)
    {
        if( $con == NULL ) { $con = BD::conectar(); }
        $query = sprintf("insert into Log (idPessoa,idCasoUso,descricao, confere) "
                . "values (%d,'%s','%s', 'SIM')",
                $idPessoa,
                $idCasoUso,
                addslashes($descricao));
