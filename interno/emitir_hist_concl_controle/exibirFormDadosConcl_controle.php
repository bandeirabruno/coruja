...
$path = $_SERVER['DOCUMENT_ROOT'].$RAIZ_CORUJA.Config::DIR_AREA_DADOS  . "/" . $filename;
   if(file_exists($path)){
...
<br />
  <table width="791" border="0" align="center">
	...
	<tr>
	  ...
	  <td>
		<select name="chforin" id="chforin" class="form_obrigatorio" required title="O campo C.H. de forma de ingresso é obrigatório" style="margin: 10px 0">
