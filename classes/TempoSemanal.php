...
class TempoSemanal {
    ...
    public static function getTempoSemanalById($idTempoSemanal) {
        ...
        $query = sprintf(
                "SELECT * " .
                "FROM TempoSemanal " .
                "WHERE idTempoSemanal = %s", mysqli_real_escape_string($con, $idTempoSemanal));
    ...
    */
    public static function obterTurmasByTempoSemanal($matriculaAluno,$situacaoInscricao,$idTempoSemanal,$idPeriodoLetivo) {
        ...
        $result = BD::mysqli_query($query,$con);
        while( $resPorTempo = mysqli_fetch_array($result) ) {
    ...
    */
    public static function obterTempoSemanalOrdenado( Curso $curso) {
        ...
        while( $resTempo = mysqli_fetch_array($result) ) {
            $tempo = new temposemanal($resTempo['idTempoSemanal'],$resTempo['siglaCurso'],$resTempo['horaInicio'],$resTempo['horaFim'],$resTempo['diaSemana']);
