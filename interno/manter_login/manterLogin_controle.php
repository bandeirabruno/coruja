...
else if( $acao === "resetarSenha")
{
    ...
    try {
        BD::mysqli_query("BEGIN", $con); // Inicia transação
        Login::alterarSenhaLogin($idPessoa, $login->getNomeAcesso(), $formLogin->getSenha(), $con);
        ...
        $msgsErro=array();
        array_push($msgsErro, "Resetada a senha e desbloqueado o login para " . $formLogin->getNome());
