<?php
    ...
    */
...

    {
        ...
        case E_USER_ERROR:
            ...
            echo "<p>Por favor comunique este erro pelo e-mail <b>ricardo.marciano@faeterj-rio.edu.br</b></p>";
    ...
    */
    ...
    if( $_SERVER['PHP_SELF'] != "/coruja/autenticar/login_controle.php" && $_SERVER['PHP_SELF'] != "/coruja/validacao/" && $_SERVER['PHP_SELF'] != "/coruja/validacao/index.php" ) {
