...
class ComponenteCurricularProposto 
{
    ...
    public static function criar($siglaCursoMatrizProposta, $idMatriz , $siglaDisciplina, $nomeDisciplina, $creditos, $cargaHoraria, $periodo, $tipoComponenteCurricular, $posicaoPeriodo = 0) {
        ...
        $query  = sprintf("insert into ComponenteCurricularProposto (siglaCurso, idMatriz, "
                         ...
                         mysqli_escape_string($con, $siglaCursoMatrizProposta), $idMatriz, 
                         mysqli_escape_string($con, $siglaDisciplina), mysqli_escape_string($con, $nomeDisciplina), $creditos, $cargaHoraria, $periodo, 
                         mysqli_escape_string($con, $tipoComponenteCurricular), $posicaoPeriodo);
    ...
    public function editar($oldSiglaDisciplina, $siglaCurso, $idMatriz, $siglaDisciplina, $nomeDisciplina, $creditos, $cargaHoraria, $periodo, $tipoComponenteCurricular, $posicaoPeriodo=0) {
        ...
        $query = sprintf("UPDATE ComponenteCurricularProposto set siglaDisciplina='%s', "
                          ...
                          mysqli_escape_string($con, $siglaDisciplina), mysqli_escape_string($con, $nomeDisciplina),
                          $creditos, $cargaHoraria, $periodo, mysqli_escape_string($con, $tipoComponenteCurricular), $posicaoPeriodo, $oldSiglaDisciplina, $siglaCurso, $idMatriz);
        ...
        $queryPreRequisitos = sprintf("UPDATE PreRequisitoProposto set siglaPreRequisito = '%s' "
                          ...
                          mysqli_escape_string($con, $siglaDisciplina), $siglaCurso, $idMatriz, $oldSiglaDisciplina);
        
        $resultPreRequisitos = BD::mysqli_query($queryPreRequisitos,$con);
    ...
    public static function obterComponeteCurricular($siglaCurso, $idUltimaMatrizEquivalente, $siglaDisciplina) {
        ...
        $query  = sprintf("SELECT * FROM ComponenteCurricularProposto WHERE siglaCurso = '%s' "
                          ...
                          mysqli_escape_string($con, $siglaCurso), $idUltimaMatrizEquivalente, mysqli_escape_string($con, $siglaDisciplina));
        $result = BD::mysqli_query($query,$con);
        
        if ($infos = mysqli_fetch_assoc($result)) {
    ...
    public function deletar() {
        ...
        $resultComponente = BD::mysqli_query($queryComponente, $con);
        ...
        $resultEquivalencia = BD::mysqli_query($queryEquivalencia, $con);
        ...
        $resultPreRequisito = BD::mysqli_query($queryPreRequisito, $con);
    ...
    public function salva() {
        ...
        $query = sprintf("UPDATE ComponenteCurricularProposto set siglaDisciplina='%s', "
                          . "nomeDisciplina='%s', creditos=%d, cargaHoraria=%d, periodo=%d, "
                          . "tipoComponenteCurricular='%s', posicaoPeriodo=%d WHERE siglaDisciplina = '%s' AND siglaCurso = '%s' AND idMatriz = %d",
                          mysqli_escape_string($con, $this->getSiglaDisciplina()), mysqli_escape_string($con, $this->getNomeDisciplina()),
                          $this->getCreditos(), $this->getCargaHoraria(), $this->getPeriodo(), mysqli_escape_string($con, $this->getTipoComponenteCurricular()),
                          $this->getPosicaoPeriodo(), mysqli_escape_string($con, $this->getSiglaDisciplina()), $this->getSiglaCurso(), $this->getIdMatriz());
