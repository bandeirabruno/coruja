...
<form id="cadastro" method="post" name="cadastro" action="/coruja/interno/manter_professor/manterProfessor_controle.php" >
    ...
    <div align="center" class="row">
        <input type="submit" id="button1" value="Editar Dados Professor" /> <input type="button" id="resetarSenha" value="Alterar Senha Professor" />
    </div>
    <br/>
...
<?php } ?>
            ...
            <p align="left"><input type="submit" id="button1" value="Nova Matrícula" onclick="document.cadastro.acao.value='preparaNovaMatricula'" /></p>
        </div>
    </fieldset>
    <br />
</form>
<!-- Modal para troca de senhas dos alunos -->
<div id="dialog-form" name="dialog-form" title="Resetar Senha" >
    <p class="validateTips">Informe a Nova Senha</p>
    <p><ul id="erro" class="erro d-none">
        <li id="erroInModal">
        
        </li>
    </ul></p>
        
    <form id="formSenha" name="formSenha" action="/coruja/interno/manter_login/manterLogin_controle.php" method="post">
        <div class="form-group">
            <label for="senha">Senha</label>
            <input type="password" class="form-control" id="senha" name="senha" placeholder="">
        </div>
        <div class="form-group">
            <label for="senha1">Repetir Senha</label>
            <input type="password" class="form-control" id="senha1" name="senha1" placeholder="">
        </div>

        <input type="hidden" id="acao" name="acao" value="resetarSenha">
        <input type="hidden" id="idPessoa" name="idPessoa" value="<?php echo $professor->getIdPessoa() ?>">
