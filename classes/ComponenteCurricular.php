...
class ComponenteCurricular 
{
    ...
    */
    function __construct($siglaCurso = null, $idMatriz = null, $siglaDisciplina = null){
    ...
    */
    public static function obterComponenteCurricular($siglaCurso, $idMatriz, $siglaDisciplina) {
        ...
        while( $resComponente = mysqli_fetch_array($result) ) {
    ...
    */
    public function obterPreRequisitos() {
        ...
        while( $resComponentePreRequisito = mysqli_fetch_array($result) ) {
    ...
    public function obterQuitacao(MatriculaAluno $matriculaAluno) {
        ...
        $query = sprintf("select t.idPeriodoLetivo as idPeriodoLetivo,cc.creditos as creditos, " .
            ...
            mysqli_real_escape_string($con, $matriculaAluno->getMatriculaAluno()),
            mysqli_real_escape_string($con, $this->getSiglaDisciplina()),
            $this->getIdMatriz());
        ...
        {
            $resCC = mysqli_fetch_array($result);
            ...
            $quitacao = new QuitacaoComponenteCurricularTO($periodoLetivo, $mediaFinal,$creditos,$isento);
    ...
    private function obterComponentesEquivalentesMatrizAnterior() {
        ...
        $query = sprintf("select ce.siglaDisciplinaEquivalente as siglaDisciplinaEquivalente " .
            ...
            mysqli_real_escape_string($con, $this->getSiglaCurso()),
            $this->getIdMatriz(),
            mysqli_real_escape_string($con, $this->getSiglaDisciplina()),
            $idMatrizAnterior);
        $col = array();
    ...
    public function obterQtdeReprovacoes(MatriculaAluno $matriculaAluno)
    {
        ...
        $query = sprintf("select count(*) from Inscricao I inner join Turma T on I.idTurma = T.idTurma "
                ...
                mysqli_real_escape_string($con,  $matriculaAluno->getNumMatriculaAluno()),
                mysqli_real_escape_string($con,  $this->getSiglaCurso()),
                $this->idMatriz,
                mysqli_real_escape_string($con,  $this->getSiglaDisciplina()) );
        $result = BD::mysqli_query($query, $con);
    ...
    public function criar() {
        ...
        $query = sprintf("INSERT INTO ComponenteCurricular (siglaCurso, idMatriz, siglaDisciplina, nomeDisciplina, creditos, cargaHoraria, periodo, "
                          . "tipoComponenteCurricular, posicaoPeriodo) VALUES ('%s', %d, '%s', '%s', %d, %d, %d, '%s', %d)",
                           $this->getSiglaCurso(), $this->getIdMatriz(), mysqli_escape_string($con, $this->getSiglaDisciplina()), mysqli_escape_string($con, $this->getNomeDisciplina()),
