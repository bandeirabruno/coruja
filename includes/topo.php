...
<head>
    ...
    <link href="/coruja/estilos/bootstrap.css" rel="stylesheet" ype="text/css" media="all">
    ...
    <script type='text/javascript' src='/coruja/interno/js/funcoesWeb.js'></script>
...
<body>
    ...
    <div id="topo">
        <?php
        // PEGA O NOME DE USU�RIO E IDPESSOA DO USU�RIO LOGADO
