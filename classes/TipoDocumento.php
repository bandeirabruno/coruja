...
class TipoDocumento {
    ...
    public static function obterTipoDocumentoPorId($id) {
        ...
        $query=sprintf("select idTipoDocumento,descricao
            from TipoDocumento where idTipoDocumento=%d",  mysqli_escape_string($con, $id));
    ...
    function __construct($idTipoDocumento = null, $descricao = null) {
    ...
    public static function obterTipoDocumentosNaoEntregues($matriculaAluno, $siglaCurso){
        ...
        $query = sprintf("
                ...
                ", mysqli_escape_string($con, $matriculaAluno), mysqli_escape_string($con, $siglaCurso));
        $result = BD::mysqli_query($query, $con);
        if (!result)
