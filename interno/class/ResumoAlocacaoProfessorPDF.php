   ...
   $arr=array();
        ...
        if(mysqli_num_rows($query)>0){
                for($i=0;$i<mysqli_num_rows($query);$i++){// loop dados do sql
                        ...
                        $arr[$i]['professor']=BD::mysqli_result($query, $i,'professor');
                        $arr[$i]['matricula']=BD::mysqli_result($query, $i,'matricula');
                        $arr[$i]['cht']=BD::mysqli_result($query, $i,'cht');
                        $arr[$i]['temposAlocados']=BD::mysqli_result($query, $i,'temposAlocados');
                        $arr[$i]['disciplinAlocada']=BD::mysqli_result($query, $i,'disciplinAlocada');
...
public function geraGrade($largura,$siglaCurso,$periodoLetivo, $espaco = ''){
	...
	$espacamentoHorizontalGrande = 6;
        ...
        $this->Cabecalho($largura, $siglaCurso, $periodoLetivo, $espaco);
