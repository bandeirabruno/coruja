...
<fieldset id="coruja">
    <legend>Concluir Matrícula</legend>
    ...
    ?>
    <p class="erro">Essa matrícula não pode ser concluída pois se encontra em situação que não permite essa operação. Operação Cancelada.</p>
    <?php
    } else {
    ?>
    <?php
    ...
    <form method="post" name="concluirMatricula"
        ...
        <p>
            Texto de Conclusão da Matrícula<br/>
        ...
        <input type="submit" value="Concluir Matrícula" />
    </form>
    <?php
            }
        }
