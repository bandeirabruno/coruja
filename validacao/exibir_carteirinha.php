  ...
  <body>
        ...
        <div class="container h-100">
            <div class="row h-100 ">
                ...
                <div class="container h-100 corpo col-lg-6 col-md-6">
                    <div class="h-100">  
                        
                        <div class="foto text-center">
                            <?php echo '<img src="data:image/jpeg;base64,'.base64_encode( $dados['foto'] ).'"/>'; ?>
                        </div>

                        <div class="corpo-dados">
                            <img class="img_logo" src="../web/assets/img/logo_nome_faeterj.jpg" />
