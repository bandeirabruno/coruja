                  ...
                  <input type="hidden" name="acao" id="acao" value="autenticar" />
                    <table>
                      ...
                      <tr>
                        <td></td>
                        <td>
                          <input class="btn-submit" type="submit" value="Entrar" tabindex="4" name="Logar" id="Logar" disabled />
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td></td>
                        <td><div style="padding:0;" class="g-recaptcha col-md-12" data-sitekey="6Lfh7AwaAAAAAADIdYwgQo9UwEv_i7UMpMg1uVPd" data-callback="retornoRecaptcha"></div></td>
                      </tr>
                    </table>
                </form>
              </td>
