...
switch ($acao) {
    ...
    case "inserirRegistroAJAX":
        ...
        //$siglaCurso = mysqli_real_escape_string($con, $_POST['siglaCurso']);
        ...
        //mysqli_real_escape_string($con, utf8_decode($_POST['turno'])); // Corrige codificação (acentuação)
        ...
        try {
            ...
            $turma = Turma::getTurmaById($novoIdTurma);
