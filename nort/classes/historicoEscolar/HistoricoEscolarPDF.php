...
class HistoricoEscolarPDF extends FpdfNort {
    ...
    function gerarCabecalho($mat) {
       ...
       /* if ($matrizId == 6){ //Matriz Antiga
            ...
            $txt = "Curso de Graduação em Tecnologia em Análise e Desenvolvimento de Sistemas";
        }
        else{ // Matriz Nova
...
RECREDENCIAMENTO:PORTARIA Número 3716 DE 26/04/2019 D.O.E.R.J. 30/04/2019'; */
    ...
    function gerarListaDisciplinasCusadas() {
        ...
        while($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
            ...
            //Gabiarra solicitada pela Jamile, Informei que iria demorar pois alteraria a regra de negócio
            //A mesma não quis esperar informando q era urgente, e assim está sendo feito mais um gambiarra no sistema
            //Só específicada caso o período = "2020.1" e a situacaoFinal = "RF"
    ...
    function gerarComponentesCurricularesPendentes() {
        ...
        while($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
            ...
            if($componenteCur->obterQuitacao($this->matriculaAluno) == null && $componenteCur->getTipoComponenteCurricular() == "OBRIGATÓRIA"){
    ...
    //Pegar as obcervaç~çoes do histórico

    public static function getObsHistorico($numeroMatriculaAluno)
    {
        $con = BD::conectar();
        // OBTEM a observação do histórico
    ...
    private function carregaNomeDoCurso() 
    {
        ...
        /*if ($matrizId < 6){ //Matriz Antiga
            ...
            $this->nomeDoCurso = "Tecnologia Em Análise E Desenvolvimento De Sistemas";
