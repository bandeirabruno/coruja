...
class DeclMatrAlunoPDF extends FpdfCoruja {
    ...
    private function gerarCorpo() {
        ...
        $texto = "Declaramos para os devidos fins que " . $this->dadosInfo['nome'].
                ", matrícula " . $this->dadosInfo['matricula'] . ", encontra-se regularmente " .
                "matriculad" . $sufixo . " nesta Instituição, no " . $this->dadosInfo['periodo'] . "º " .
                "período do Curso Superior de " . $nomeCurso . ", " .
    ...
    private function gerarAssinaturaEletronica() {
        ...
        $this->Text($posicaoXDaLinha + 22, $alturaDaLinha + 6, "Assinatura Eletrônica");
