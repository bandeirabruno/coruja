...
class buscaAluno
{
    ...
    function buscaAlunoByNome($nomeAluno){
        ...
        $query=sprintf("SELECT p.idPessoa, matriculaAluno, nome, m.siglaCurso, situacaoMatricula, nomeCurso ".
                ...
                "WHERE nome like '%s%%' order by nome",mysqli_real_escape_string($con, $nomeAluno));
    ...
    function buscaAlunoByMatricula($matriculaAluno){
        ...
        $query=sprintf("SELECT p.idPessoa, matriculaAluno, nome, m.siglaCurso, situacaoMatricula, nomeCurso ".
                ...
                "INNER JOIN Curso c ".
                "ON m.siglaCurso = c.siglaCurso ".
                "WHERE m.matriculaAluno = '%s' order by nome ",mysqli_real_escape_string($con, $matriculaAluno));
        $result=BD::mysqli_query($query,$con);
